...
CREATE TABLE `companies` (
  ...
  KEY `fk_companies_users_idx` (`user_id`),
  KEY `fk_companies_company_type_idx` (`type`),
  CONSTRAINT `fk_companies_company_type` FOREIGN KEY (`type`) REFERENCES `company_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_companies_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-03-01 19:19:31
